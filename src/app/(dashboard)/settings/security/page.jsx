...
const Security = () => {
  ...
  return (
    <div className="flex flex-col gap-6 px-6 w-full">
      ...
      <div className="flex flex-col gap-6  pb-10 w-full" autoComplete="off">
        {/* email address */}
        ...
        <div className="flex flex-col gap-2 items-start w-full">
          ...
          >
            <span className="text-base font-Raleway font-semibold leading-normal text-primary-10">Log Out Of All Sessions</span>
