...
import { FaUserTag, FaChevronRight, FaFileAlt, FaCreditCard, FaLock, FaBell, FaUserLock, FaBuilding } from "react-icons/fa";
...
const settingsLinks = [
  ...
  {
    id: 7,
    name: "Property Listing Requirements",
    icon: <FaBuilding size={20} className="text-primary-20" />,
    path: "/settings/property-listing-requirements",
  },
];
