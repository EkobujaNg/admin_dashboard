...
const AccountPage = () => {
  ...
  const activeTable = useReactTable<any>({
    data: (users || []) as any[],
  ...
  const pendingTable = useReactTable<any>({
    data: (users || []) as any[],
  ...
  const renderPagination = useCallback((tableInstance: any) => {
  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      <ConfirmationModal
        ...
        confirmButtonColor={confirmAction.type === "accept" || confirmAction.type === "activate" ? "green" : "red"}
